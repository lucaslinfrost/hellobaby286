...
use DialogFlow\DialogFlow_Client;
...
class GuzzleHttpClient implements HttpClient
{
    ...
    public function __construct(ClientInterface $guzzleClient = null)
    {
        $this->guzzleClient = $guzzleClient ?: new GuzzleClient([
            'base_uri' => DialogFlow_Client::API_BASE_URI . DialogFlow_Client::DEFAULT_API_ENDPOINT,
            'timeout' => DialogFlow_Client::DEFAULT_TIMEOUT,
            'connect_timeout' => DialogFlow_Client::DEFAULT_TIMEOUT,
        ]);
    }
