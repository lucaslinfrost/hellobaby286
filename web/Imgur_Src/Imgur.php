...
//require 'vendor/autoload.php';
 ...
 require_once('./Imgur_Src/Account.php');
 require_once('./Imgur_Src/Album.php');
 require_once('./Imgur_Src/Authorize.php');
 require_once('./Imgur_Src/Comment.php');
 require_once('./Imgur_Src/Connect.php');
 require_once('./Imgur_Src/Gallery.php');
 require_once('./Imgur_Src/Image.php');
 require_once('./Imgur_Src/Message.php');
 require_once('./Imgur_Src/Notification.php');
 require_once('./Imgur_Src/Upload.php');
